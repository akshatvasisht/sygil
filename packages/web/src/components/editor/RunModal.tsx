              ...
              {paramEntries.map(([key, def]) => (
                <div key={key}>
                  ...
                  <input
                    ...
                    className="w-full min-h-[44px] bg-canvas border border-border rounded px-2.5 py-1.5 font-mono text-xs text-bright placeholder:text-dim focus:outline-none focus:border-accent transition-colors duration-200"
                  />
                </div>
              ))}
            </div>
