...
import { SygilLogo } from "./SygilLogo";

describe("SygilLogo", () => {
  it("renders an SVG element", () => {
    const { container } = render(<SygilLogo />);
  ...
  it("applies custom size", () => {
    const { container } = render(<SygilLogo size={48} />);
    const svg = container.querySelector("svg")!;
  ...
  it("applies custom color", () => {
    const { container } = render(<SygilLogo color="#888888" />);
    const rects = container.querySelectorAll("rect");
    rects.forEach((rect) => {
  ...
  it("applies className prop", () => {
    const { container } = render(<SygilLogo className="my-class" />);
    const svg = container.querySelector("svg")!;
