    ...
    <main className="min-h-screen flex items-center justify-center bg-canvas text-bright px-6">
      <div className="max-w-md w-full card-glow-accent rounded-lg bg-panel border border-border p-8 flex flex-col gap-5">
        <div className="flex items-center gap-3">
          ...
          <span className="font-mono text-sm uppercase tracking-wider text-dim">sygil / monitor / error</span>
        </div>
        <h1 className="text-lg font-sans">The monitor hit an error.</h1>
        <p className="text-body text-sm leading-relaxed">
          The workflow connection may have been interrupted. Retrying will reconnect
          the WebSocket; your run on the CLI side is unaffected.
        </p>
        ...
        <div className="flex gap-3">
          <button
            ...
            aria-label="Reconnect the monitor"
          >
            Try again
          </button>
          <button
